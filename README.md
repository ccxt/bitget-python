...
- `create_uta_orders(self, orders: list[OrderRequest], params: dict = {})`
...
- `fetch_default_markets(self, params: object)`
...
- `fetch_funding_intervals(self, symbols: Strings = None, params: dict = {})`
- `fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_funding_rate(self, symbol: str, params: dict = {})`
...
- `fetch_uta_canceled_and_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_uta_markets(self, params: object)`
...
- `cancel_uta_orders(self, ids: list[str], symbol: Str = None, params: dict = {})`
- `close_all_positions(self, params: dict = {})`
...
- `public_uta_get_v3_market_risk_reserve_all(request)`
- `public_uta_get_v3_market_risk_reserve_hour(request)`
- `public_uta_get_v3_market_score_weights(request)`
- `public_uta_get_v3_market_fee_group(request)`
- `public_uta_get_v3_market_cash_dividend_records(request)`
- `public_uta_get_v3_market_split_records(request)`
- `public_uta_get_v3_market_liquidations(request)`
- `public_uta_get_v3_market_rpi_orderbook(request)`
- `public_uta_get_v3_market_rpi_symbols(request)`
- `public_uta_get_v3_market_spot_whale_flow(request)`
- `public_uta_get_v3_market_spot_fund_flow(request)`
- `public_uta_get_v3_market_spot_net_flow(request)`
- `public_uta_get_v3_market_margin_long_short(request)`
- `public_uta_get_v3_market_margin_loan_growth(request)`
- `public_uta_get_v3_market_margin_isolated_borrow(request)`
- `public_uta_get_v3_market_futures_active_buy_sell(request)`
- `public_uta_get_v3_market_futures_long_short(request)`
- `public_uta_get_v3_market_futures_position_long_short(request)`
- `public_uta_get_v3_market_futures_account_long_short(request)`
- `public_uta_get_v3_reality_market_stock_info(request)`
- `public_uta_get_v3_reality_market_states(request)`
- `public_uta_get_v3_reality_market_calendar(request)`
- `public_uta_get_v3_reality_market_company_overview(request)`
- `public_uta_get_v3_reality_market_valuation_indicators(request)`
- `public_uta_get_v3_reality_market_earnings_forecast(request)`
- `public_uta_get_v3_reality_market_suspension_resumption_info(request)`
- `public_uta_get_v3_reality_market_dividends(request)`
- `public_uta_get_v3_reality_market_share_capital_change(request)`
- `public_uta_get_v3_reality_market_inner_trades(request)`
- `public_uta_get_v3_reality_market_executive_shareholdings(request)`
- `public_uta_get_v3_reality_market_sharehold_detail(request)`
- `public_uta_get_v3_account_custom_collateral_coins(request)`
...
- `private_user_post_v2_user_create_agent_subaccount(request)`
...
- `private_broker_get_v2_broker_sub_customer_list(request)`
- `private_broker_get_v2_broker_agent_commission(request)`
- `private_broker_get_v2_broker_customer_commissions(request)`
- `private_broker_get_v2_broker_customer_kyc_result(request)`
- `private_broker_get_v2_broker_order_commission(request)`
- `private_broker_get_v2_broker_rebate_info(request)`
- `private_broker_get_v2_broker_total_commission(request)`
...
- `private_broker_post_v2_broker_customer_asset(request)`
- `private_broker_post_v2_broker_customer_deposit(request)`
- `private_broker_post_v2_broker_customer_list(request)`
- `private_broker_post_v2_broker_customer_trade_volume(request)`
...
- `private_earn_get_v2_earn_elite_product(request)`
- `private_earn_get_v2_earn_elite_assets(request)`
- `private_earn_get_v2_earn_elite_records(request)`
- `private_earn_get_v2_earn_elite_subscribe_info(request)`
- `private_earn_get_v2_earn_elite_subscribe_result(request)`
- `private_earn_get_v2_earn_elite_redeem_info(request)`
...
- `private_earn_post_v2_earn_elite_subscribe(request)`
- `private_earn_post_v2_earn_elite_redeem(request)`
- `private_common_get_v2_common_trade_rate(request)`
- `private_uta_get_v3_account_assets(request)`
- `private_uta_get_v3_account_funding_assets(request)`
...
- `private_uta_get_v3_account_deduct_info(request)`
- `private_uta_get_v3_account_fee_rate(request)`
- `private_uta_get_v3_account_switch_status(request)`
- `private_uta_get_v3_account_max_transferable(request)`
- `private_uta_get_v3_account_open_interest_limit(request)`
- `private_uta_get_v3_account_sub_unified_assets(request)`
- `private_uta_get_v3_account_transferable_coins(request)`
- `private_uta_get_v3_account_sub_transfer_record(request)`
- `private_uta_get_v3_account_deposit_address(request)`
- `private_uta_get_v3_account_sub_deposit_address(request)`
- `private_uta_get_v3_account_deposit_records(request)`
- `private_uta_get_v3_account_sub_deposit_records(request)`
- `private_uta_get_v3_account_withdrawal_records(request)`
- `private_uta_get_v3_broker_sub_list(request)`
- `private_uta_get_v3_broker_all_sub_deposit_withdrawal(request)`
- `private_uta_get_v3_broker_commission(request)`
- `private_uta_get_v3_broker_query_sub_apikey(request)`
...
- `private_uta_get_v3_loan_coins(request)`
- `private_uta_get_v3_loan_interest(request)`
- `private_uta_get_v3_loan_borrow_ongoing(request)`
- `private_uta_get_v3_loan_borrow_history(request)`
- `private_uta_get_v3_loan_repay_history(request)`
- `private_uta_get_v3_loan_pledge_rate_history(request)`
- `private_uta_get_v3_loan_debts(request)`
- `private_uta_get_v3_loan_reduces(request)`
- `private_uta_get_v3_position_current_position(request)`
- `private_uta_get_v3_position_history_position(request)`
- `private_uta_get_v3_position_adlrank(request)`
- `private_uta_get_v3_tax_records(request)`
...
- `private_uta_get_v3_account_info(request)`
- `private_uta_get_v3_account_all_fee_rate(request)`
- `private_uta_get_v3_account_delta_info(request)`
- `private_uta_get_v3_account_withdraw_address(request)`
- `private_uta_get_v3_account_max_withdrawal(request)`
- `private_uta_get_v3_account_move_position_history(request)`
- `private_uta_get_v3_account_collateral_type(request)`
- `private_uta_get_v3_account_pre_set_leverage(request)`
- `private_uta_get_v3_account_eligible_symbols(request)`
- `private_uta_get_v3_account_eligible_margin_tier(request)`
- `private_uta_get_v3_account_eligible_loan_info(request)`
- `private_uta_get_v3_account_eligible_discount_rate(request)`
- `private_uta_get_v3_account_funding_financial_records(request)`
- `private_uta_get_v3_account_reality_orderbook(request)`
- `private_uta_get_v3_account_reality_fills(request)`
- `private_uta_get_v3_copy_futures_trading_pairs(request)`
- `private_uta_get_v3_copy_futures_position_summary(request)`
- `private_uta_get_v3_copy_futures_max_transferable(request)`
- `private_uta_get_v3_copy_futures_transfer_record(request)`
- `private_uta_get_v3_copy_futures_current_follower(request)`
- `private_uta_get_v3_copy_futures_history_follower(request)`
- `private_uta_get_v3_copy_futures_profit_summary(request)`
- `private_uta_get_v3_copy_futures_profit_details(request)`
- `private_uta_get_v3_convert_small_assets(request)`
- `private_uta_get_v3_convert_small_assets_history(request)`
- `private_uta_get_v3_earn_elite_product(request)`
- `private_uta_get_v3_earn_elite_assets(request)`
- `private_uta_get_v3_earn_elite_subscribe_info(request)`
- `private_uta_get_v3_earn_elite_records(request)`
- `private_uta_get_v3_earn_elite_subscribe_result(request)`
- `private_uta_get_v3_earn_elite_redeem_info(request)`
- `private_uta_get_v3_trade_loan_data(request)`
- `private_uta_get_v3_trade_strategy_sub_orders(request)`
- `private_uta_get_v3_trade_grid_bot_detail(request)`
- `private_uta_get_v3_trade_grid_list_details(request)`
- `private_uta_get_v3_trade_grid_neutral_bot_detail(request)`
- `private_uta_get_v3_trade_grid_neutral_list_details(request)`
- `private_uta_get_v3_user_rate_limit_quota(request)`
- `private_uta_get_v3_stockplus_market_option_quote(request)`
- `private_uta_get_v3_stockplus_market_option_chain_info(request)`
- `private_uta_get_v3_stockplus_market_option_expiry_date(request)`
- `private_uta_get_v3_stockplus_market_option_volume(request)`
- `private_uta_get_v3_stockplus_market_depth(request)`
- `private_uta_get_v3_stockplus_market_static(request)`
- `private_uta_get_v3_stockplus_market_quote(request)`
- `private_uta_get_v3_stockplus_market_trade(request)`
- `private_uta_get_v3_stockplus_market_intraday(request)`
- `private_uta_get_v3_stockplus_market_history_candlestick(request)`
- `private_uta_get_v3_stockplus_market_candlestick(request)`
- `private_uta_get_v3_stockplus_trade_today_orders(request)`
- `private_uta_get_v3_stockplus_trade_history_orders(request)`
- `private_uta_get_v3_stockplus_trade_order_detail(request)`
- `private_uta_get_v3_stockplus_trade_today_executions(request)`
- `private_uta_get_v3_stockplus_trade_history_executions(request)`
- `private_uta_get_v3_stockplus_asset_account(request)`
- `private_uta_get_v3_stockplus_asset_cash_flow(request)`
- `private_uta_get_v3_stockplus_asset_stock_position(request)`
- `private_uta_get_v3_stockplus_asset_transfer_records(request)`
- `private_uta_get_v3_p2p_ad_list(request)`
- `private_uta_get_v3_p2p_ad_info(request)`
- `private_uta_get_v3_p2p_ad_limit(request)`
- `private_uta_get_v3_p2p_my_ads(request)`
- `private_uta_get_v3_p2p_pending_orders(request)`
- `private_uta_get_v3_p2p_all_orders(request)`
- `private_uta_get_v3_p2p_order_info(request)`
- `private_uta_get_v3_p2p_user_info(request)`
- `private_uta_get_v3_p2p_currencies(request)`
- `private_uta_get_v3_p2p_pay_method(request)`
- `private_uta_get_v3_p2p_balance(request)`
- `private_uta_get_v3_p2p_exchange_rate(request)`
...
- `private_uta_post_v3_account_switch_deduct(request)`
- `private_uta_post_v3_account_deposit_account(request)`
- `private_uta_post_v3_account_switch(request)`
- `private_uta_post_v3_account_adjust_account_mode(request)`
- `private_uta_post_v3_account_transfer(request)`
- `private_uta_post_v3_account_sub_transfer(request)`
- `private_uta_post_v3_account_sub_master_transfer(request)`
- `private_uta_post_v3_account_max_open_available(request)`
- `private_uta_post_v3_account_withdrawal(request)`
- `private_uta_post_v3_broker_create_sub(request)`
- `private_uta_post_v3_broker_modify_sub(request)`
- `private_uta_post_v3_broker_sub_withdrawal(request)`
- `private_uta_post_v3_broker_sub_deposit_address(request)`
- `private_uta_post_v3_broker_create_sub_apikey(request)`
- `private_uta_post_v3_broker_modify_sub_apikey(request)`
- `private_uta_post_v3_broker_delete_sub_apikey(request)`
- `private_uta_post_v3_ins_loan_bind_uid(request)`
- `private_uta_post_v3_loan_borrow(request)`
- `private_uta_post_v3_loan_repay(request)`
- `private_uta_post_v3_loan_revise_pledge(request)`
...
- `private_uta_post_v3_trade_countdown_cancel_all(request)`
...
- `private_uta_post_v3_account_move_positions(request)`
- `private_uta_post_v3_account_cancel_withdrawal(request)`
- `private_uta_post_v3_account_set_margin(request)`
- `private_uta_post_v3_account_set_collateral_type(request)`
- `private_uta_post_v3_copy_futures_transfer(request)`
- `private_uta_post_v3_convert_small_assets_trade(request)`
- `private_uta_post_v3_earn_elite_subscribe(request)`
- `private_uta_post_v3_earn_elite_redeem(request)`
- `private_uta_post_v3_trade_place_reality_order(request)`
- `private_uta_post_v3_trade_cancel_reality_order(request)`
- `private_uta_post_v3_trade_grid_validate(request)`
- `private_uta_post_v3_trade_grid_create_bot(request)`
- `private_uta_post_v3_trade_grid_modify_bot(request)`
- `private_uta_post_v3_trade_grid_modify_grid_interval(request)`
- `private_uta_post_v3_trade_grid_add_investment(request)`
- `private_uta_post_v3_trade_grid_close_bot(request)`
- `private_uta_post_v3_trade_grid_validate_neutral(request)`
- `private_uta_post_v3_trade_grid_create_neutral_bot(request)`
- `private_uta_post_v3_trade_grid_modify_neutral_bot(request)`
- `private_uta_post_v3_trade_grid_modify_neutral_grid_interval(request)`
- `private_uta_post_v3_user_set_rate_limit_quota(request)`
- `private_uta_post_v3_user_sub_account_agent_create(request)`
- `private_uta_post_v3_stockplus_trade_place_order(request)`
- `private_uta_post_v3_stockplus_trade_cancel_order(request)`
- `private_uta_post_v3_stockplus_trade_modify_order(request)`
- `private_uta_post_v3_stockplus_asset_transfer(request)`
- `private_uta_post_v3_p2p_ad_create(request)`
- `private_uta_post_v3_p2p_ad_update(request)`
- `private_uta_post_v3_p2p_ad_operate(request)`
- `private_uta_post_v3_p2p_fee_simulate(request)`
- `private_uta_post_v3_p2p_order_pay(request)`
- `private_uta_post_v3_p2p_order_release(request)`

### WS Unified

- `describe(self)`
- `get_inst_type(self, methodName: Str, market: Market, uta: bool = False, params: dict = {})`
...
- `un_watch_channel(self, symbol: str, channel: str, messageHashTopic: str, methodName: str, params={})`
...
- `watch_public(self, uta: bool, messageHash: str, args: dict, params: dict = {})`
- `un_watch_public(self, uta: bool, messageHash: str, args: dict, params: dict = {})`
- `watch_public_multiple(self, uta: bool, messageHashes: list[str], argsArray: list[object], params: dict = {})`
- `authenticate(self, params: dict = {})`
- `watch_private(self, uta: bool, messageHash: str, subscriptionHash: str, args: dict, params: dict = {})`
