...
- `fetch_default_markets(self, params: Any)`
...
- `fetch_uta_markets(self, params: Any)`
...
- `cancel_uta_orders(self, ids: Any, symbol: Str = None, params={})`
...
- `describe(self)`
- `get_inst_type(self, methodName: Any, market: Any, uta: bool = False, params={})`
...
- `watch_public(self, uta: Any, messageHash: Any, args: Any, params={})`
- `un_watch_public(self, uta: Any, messageHash: Any, args: Any, params={})`
- `watch_public_multiple(self, uta: Any, messageHashes: Any, argsArray: Any, params={})`
- `authenticate(self, params={})`
- `watch_private(self, uta: Any, messageHash: Any, subscriptionHash: Any, args: Any, params={})`
