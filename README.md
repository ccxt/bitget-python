...
- `describe(self)`
- `get_inst_type(self, methodName, market, uta: bool = False, params={})`
...
- `watch_public(self, uta, messageHash, args, params={})`
- `un_watch_public(self, uta, messageHash, args, params={})`
- `watch_public_multiple(self, uta, messageHashes, argsArray, params={})`
- `authenticate(self, params={})`
- `watch_private(self, uta, messageHash, subscriptionHash, args, params={})`
